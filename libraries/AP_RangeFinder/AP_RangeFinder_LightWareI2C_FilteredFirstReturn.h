...
class AP_RangeFinder_LightWareI2CFILTEREDFIRSTRETURN : public AP_RangeFinder_Backend
{
...
private:
    ...
    // constructor
    AP_RangeFinder_LightWareI2CFILTEREDFIRSTRETURN(RangeFinder::RangeFinder_State &_state,
                                AP_RangeFinder_Params &_params,
                                AP_HAL::OwnPtr<AP_HAL::I2CDevice> dev);
